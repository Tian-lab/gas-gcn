...
import numpy as np
import math
from model.se_block import SELayer
...
class unit_tcn(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size=9, stride=1):
        ...
        self.c = in_channels
        self.conv = GatedCNN(in_channels, out_channels, kernel_size=(kernel_size, 1), padding=(pad, 0),
                              stride=(stride, 1))
...
class unit_gcn(nn.Module):
    def __init__(self, in_channels, out_channels, A, coff_embedding=4, num_subset=3):
        ...
        for i in range(self.num_subset):
            ...
            self.conv_c.append(nn.Conv2d(in_channels, 1, 1))
    ...
    def forward(self, x):
        ...
        for i in range(self.num_subset):
            ...
            x_beta = self.GAP(self.conv_c[i](x)) # N 1 1 1
            beta = torch.squeeze(x_beta,3)  # N 1 1
            A1 = beta*A1 + A[i]
...
class Model(nn.Module):
    def __init__(self, num_class=60, num_point=25, num_person=2, graph=None, graph_args=dict(), in_channels=15):
        ...
        self.l1 = TCN_GCN_unit(15, 64, A, residual=False)
